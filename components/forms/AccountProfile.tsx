            ...
            render={({ field }) => (
              <FormItem className="flex items-center gap-4">
                <FormLabel className="account-form_image-label">
                    {field.value ? 
                    <Image src={field.value} alt="profile photo" height={100} width={100} priority className="object-contain rounded-full"/>
                    :
                    <Image src="/assets/profile.svg" alt="profile photo" height={25} width={25} className="rounded-full"/>
                 }
                </FormLabel>
